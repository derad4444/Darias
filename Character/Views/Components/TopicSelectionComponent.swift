...
struct TopicSelectionComponent: View {
    let onTopicSelected: (Int) -> Void
...
struct TopicSelectionComponent_Previews: PreviewProvider {
    static var previews: some View {
        TopicSelectionComponent { _ in }
